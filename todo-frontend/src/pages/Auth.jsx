                ...
                <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-yellow-800">
                      <p className="font-medium mb-1">⚠️ Email Service Notice</p>
                      <p>Mail service using nodemailer won't work because backend is hosted on Render and it blocks Gmail SMTP ports.</p>
                    </div>
                  </div>
                </div>
