                ...
                <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-blue-800">
                      <p className="font-medium mb-1">📧 Welcome Email Notice</p>
                      <p>To receive the welcome email, please use a real email address or a temporary email service where you can receive emails.</p>
                    </div>
                  </div>
                </div>
